...
T = 0:dt:10;                    % time span
th1_0 = [qd0(1); 0.0];            % link 1 position and velocity
th2_0 = [qd0(2); 0.0];            % link 2 position and velocity
th3_0 = [qd0(3); 0.0];            % link 3 position and velocity
