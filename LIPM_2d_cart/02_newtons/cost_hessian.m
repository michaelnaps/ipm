...
function [H] = cost_hessian(P, dt, q0, u0, u, c, m, L, Cq, qd, h, loc)
    %% Setup
    N = length(u);
    H = zeros(N);
    ...
    for i = 1:N
        ...
        Hn1 = cost_gradient(P, dt, q0, u0, un1, c, m, L, Cq, qd, h, " Hessian (i-1) " + loc);
        Hp1 = cost_gradient(P, dt, q0, u0, up1, c, m, L, Cq, qd, h, " Hessian (i+1) " + loc);
...
%         up2(i) = u(i) + 2*h;
% 
%         Hn2 = cost_gradient(P, dt, q0, u0, un2, c, m, L, Cq, qd, h);
%         Hp2 = cost_gradient(P, dt, q0, u0, up2, c, m, L, Cq, qd, h);
% 
